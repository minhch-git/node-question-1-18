...
Request data is validated using [Joi](https://github.com/jquense/yup). Check the [documentation](https://github.com/jquense/yup) for more details on how to write Joi validation schemas.
